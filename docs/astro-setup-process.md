...
## Phase 5 — Clean up wrong keywords

Use MCP **`remove_keywords`** (or `./scripts/astro-prune-keywords.sh` in repos that ship it). In Astro UI you can also remove keywords that:
...
| `remove_keywords` | Bulk remove (max 100) |
...
| sober | Sober Tracker - Alcohol Free | 6768869215 (ASC); Astro temp **Sober** `103` — see `docs/astro-aso-setup.md` |
