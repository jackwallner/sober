...
Use the free core for your counter, check-ins, calendar, and garden. Eligible new subscribers can try Bloom+ free for 7 days. Then $19.99/year or $2.99/month. A $39.99 lifetime option is also available.

Payment is charged to your Apple ID after trial confirmation. Subscriptions renew automatically unless cancelled at least 24 hours before the current period ends. Your account is charged within 24 hours before renewal. Manage or cancel in Settings > Apple ID > Subscriptions.

Sober is a wellness tracker, not medical care, diagnosis, or treatment. If stopping alcohol may put you at risk of withdrawal, contact a qualified clinician.

Privacy: https://jackwallner.github.io/sober/privacy-policy.html
Terms (EULA): https://www.apple.com/legal/internet-services/itunes/dev/stdeula/"""

LOCALES: dict[str, dict[str, str]] = {
    "en-US": {
        "name": "Sober: Sobriety Day Counter",
        "subtitle": "Quit Drinking, Grow Each Day",
        "keywords": "alcohol,tracker,diary,cravings,relapse,calendar,watch,private,abstinence,recovery,streak,checkin",
